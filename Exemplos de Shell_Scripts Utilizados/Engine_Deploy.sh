...
export SERVICE=`docker service ls | cut -c 20-44 | grep ${RD_OPTION_PROJETO}` #CHECAR EXISTENCIA DO SERVICE DO PROJETO EXISTENTE NO GITLAB UTILIZANDO O VALOR DA VARIAVEL RD_OPTION_PROJETO.
